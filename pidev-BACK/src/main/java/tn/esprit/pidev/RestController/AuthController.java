...
import tn.esprit.pidev.Email.EmailConfig;
...
import tn.esprit.pidev.payload.response.JwtResponse;
...
import tn.esprit.pidev.security.services.IEmailService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        emailService.sendUserAddedEmail(user.getEmail());
